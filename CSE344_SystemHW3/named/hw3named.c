...
void init_semaphores(char* name){
	...
	sem_chef4 = sem_open("sem_chef4",(O_CREAT | O_RDWR | O_EXCL), 0666, 0);
    if (sem_chef4 < 0)
	{
		perror("sem_init");
		exit(EXIT_FAILURE);
	...
	sem_chef5 = sem_open("sem_chef5",(O_CREAT | O_RDWR | O_EXCL), 0666, 0);
    if (sem_chef5 < 0)
	{
		perror("sem_init");
		exit(EXIT_FAILURE);
	...
	walnut = sem_open("walnut",(O_CREAT | O_RDWR | O_EXCL), 0666, 0);
    if (walnut < 0)
	{
		perror("sem_init");
		exit(EXIT_FAILURE);
	...
	milk = sem_open("milk",(O_CREAT | O_RDWR | O_EXCL), 0666, 0);
    if (milk < 0)
	{
		perror("sem_init");
		exit(EXIT_FAILURE);
	...
	flour = sem_open("flour",(O_CREAT | O_RDWR | O_EXCL), 0666, 0);
    if (flour < 0)
	{
		perror("sem_init");
		exit(EXIT_FAILURE);
	...
	sugar = sem_open("sugar",(O_CREAT | O_RDWR | O_EXCL), 0666, 0);
    if (sugar < 0)
	{
		perror("sem_init");
		exit(EXIT_FAILURE);
	...
	sem_mux = sem_open("sem_mux",(O_CREAT | O_RDWR | O_EXCL), 0666, 1);
    if (sem_mux < 0)
	{
		perror("sem_init");
		exit(EXIT_FAILURE);
	...
	is_done = sem_open("is_done",(O_CREAT | O_RDWR | O_EXCL), 0666, 0);
    if (is_done < 0)
	{
		perror("sem_init");
		exit(EXIT_FAILURE);
